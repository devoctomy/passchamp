...
public class VaultIndexLoaderService : IVaultIndexLoaderService
{
    public IReadOnlyList<VaultIndex> Vaults => _vaults;

    private readonly VaultIndexLoaderServiceOptions _options;
    private readonly IIOService _ioService;

    private List<VaultIndex> _vaults;

    [ActivatorUtilitiesConstructor]
    public VaultIndexLoaderService(
        VaultIndexLoaderServiceOptions options,
